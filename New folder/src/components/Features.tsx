...
const modules = [
  ...
  },
  {
    ...
    desc: 'منصة لإدارة المؤسسات ذات الرسالة: البرامج، المستفيدون، المتطوعون، الوثائق، الحوكمة، والتقارير.',
    features: ['إدارة مؤسسية', 'صلاحيات وسير عمل', 'تقارير ولوحات مؤشرات'],
    color: 'emerald',
