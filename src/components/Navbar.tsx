        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 w-3 h-3 bg-teal-400 rounded-full border-2 border-navy"></div>
            </div>
            <div>
              <h1 className="text-xl font-bold text-gold-gradient font-arabic leading-none">منارة</h1>
              <p className="text-xs text-teal-400 leading-none tracking-wider">Manara</p>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <span className="text-amber-400 text-sm font-arabic cursor-pointer hover:text-amber-300 transition-colors">EN</span>
            <span className="text-gray-500">|</span>
            <span className="text-amber-400 text-sm font-arabic cursor-pointer hover:text-amber-300 transition-colors">عربي</span>
            <button
          ...
          >
            <span className={`block h-0.5 w-6 bg-amber-400 transition-all duration-300 ${mobileOpen ? 'rotate-45 translate-y-2' : ''}`}></span>
            <span className={`block h-0.5 w-6 bg-amber-400 transition-all duration-300 ${mobileOpen ? 'opacity-0' : ''}`}></span>
            <span className={`block h-0.5 w-6 bg-amber-400 transition-all duration-300 ${mobileOpen ? '-rotate-45 -translate-y-2' : ''}`}></span>
          </button>
        </div>
      </div>
